  ...
  return (
    <section id="contact" className="relative scroll-mt-24 py-20 md:py-28">
      <div className="container-shell">
        <div className="relative overflow-hidden rounded-3xl border border-white/[0.09] bg-[radial-gradient(ellipse_100%_100%_at_50%_120%,#16294a_0%,#0a1628_45%,#050b16_85%)] px-6 py-20 text-center md:px-16 md:py-28">
          ...
          <div className="relative mx-auto flex max-w-3xl flex-col items-center">
            ...
            <Reveal direction="up" delay={0.16}>
              <p className="mt-7 max-w-xl text-lg leading-relaxed text-muted">
                Tell us where you want to be twelve months from now. We&apos;ll send back a real
                flight plan — scope, timeline, and price — within two business days.
              </p>
            </Reveal>

            <Reveal direction="up" delay={0.24}>
              <div className="mt-11 flex flex-col items-center gap-3 sm:flex-row">
                <Button href={`mailto:${company.email}`} size="lg">
                  Start Your Launch
            ...
            <Reveal direction="up" delay={0.32}>
              <ul className="mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 font-mono text-[0.625rem] tracking-[0.16em] text-muted-dim uppercase">
                {["No long-term contracts", "Houston-based team", "Reply in 2 business days"].map(
                  (item) => (
